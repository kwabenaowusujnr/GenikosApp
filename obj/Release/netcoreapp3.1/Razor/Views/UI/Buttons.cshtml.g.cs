#pragma checksum "E:\PROJECTS\GENIKOS\GenikosApp\Views\UI\Buttons.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a03c9bdcf34a35dbfa1542b3c604911794ac9988"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a03c9bdcf34a35dbfa1542b3c604911794ac9988", @"/Views/UI/Buttons.cshtml")]
        ...
        <div class=""col-lg-6"">
            <div class=""card m-b-30"">
                <div class=""card-body"">
                    ...
                    <p class=""text-muted m-b-30 "">Bootstrap includes six predefined button styles, each serving its own semantic purpose.</p>
            ...
            WriteLiteral(@"waves-effect waves-light"">Danger</button>
        ...
        <div class=""col-lg-6"">
            <div class=""card m-b-30"">
                <div class=""card-body"">
                    ...
                    <div class=""button-items"">
                        <button ");
            WriteLiteral(@"type=""button"" class=""btn btn-outline-primary waves-effect waves-light"">Primary</button>
    ...
    <div class=""row"">");
        ...
        <div class=""col-lg-6"">
            <div class=""card m-b-30"">
                <div class=""card-body"">
                  ...
                  ");
            WriteLiteral(@"      <input class=""btn btn-info"" type=""button"" value=""Input"">
        ...
        <div class=""col-lg-6"">
            ...
            WriteLiteral(@"dary btn-lg waves-effect"">Large button</button>
            ...
            <div class=""card m-b-30"">
                <div class=""card-body"">
                    ...
                    <p class=""text-muted m-b-30 "">
                        ...
                        span the full width of a parent—by adding <code class=""highlighter-rouge"">.btn-block</code>.
                    </p>

                    <div class=""button-items"">
                        <button type=""button"" class=""btn btn-primary btn-lg btn-block waves-effect waves-light"">Block");
            WriteLiteral(@" level button</button>
        ...
        <div class=""col-lg-6"">
            <div class=""card m-b-30"">
                <div class=""card-body"">
                    ...
                    <p class=""text-muted m-b-30 "">
                        Add <code class=""highlighter-rouge"">data-toggle=""button""</code>
...
");
        ...
        <div class=""col-lg-6"">
            <div class=""card m-b-30"">
                <div class=""card-body"">
                    ...
                    <p class=""text-muted m-b-30 "">
                        Bootstrap’s <code class=""highlighter-rouge"">.button</code> styles can be applied to
                        other elements, such as <code class=""highlighter-rouge"">
                            &lt;label&gt;
                        </code>s, to provide checkbox or radio style button
                        toggling. Add <code class=""highlighter-rouge"">data-toggl");
            WriteLiteral(@"e=""buttons""</code> to a
        ...
        <div class=""col-lg-6"">
            <div class=""card m-b-30"">
                <div class=""card-body"">
                   ...
                   ");
            WriteLiteral(@" <h4 class=""mt-0 header-title"">Radio buttons</h4>
                    <p class=""text-muted m-b-30 "">
                        Bootstrap’s <code class=""highlighter-rouge"">.button</code> styles can be applied to
                        other elements, such as <code class=""highlighter-rouge"">
                            &lt;label&gt;
    ...
    <div class=""row"">
        <div class=""col-lg-6"">
            <div class=""card m-b-30"">
                <div class=""card-body"">
                    ...
                    <p class=""text-muted m-b-30 "">
                        Wrap a series of buttons with <code class=""highlighter-rouge"">.btn</code> in <code class=""highlighter-rouge"">.btn-group</code>.
                    </p>

                    <div class=""btn-group"" role=""group"" aria-label=""Basic example"">
                        <button type=""button"" class=""btn btn-second");
            WriteLiteral(@"ary"">Left</button>
        ...
        <div class=""col-lg-6"">
            ...
            WriteLiteral(@"lass=""btn btn-secondary"">1</button>
        ...
        <div class=""col-lg-6"">
            <div class=""card m-b-30"">
                <div class=""card-body"">
                    ...
                    <h4 clas");
            WriteLiteral(@"s=""mt-0 header-title"">Vertical variation</h4>
                    <p class=""text-muted m-b-30 "">
